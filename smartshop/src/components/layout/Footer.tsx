        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-sm">
          <div className="col-span-2">
            ...
            <form className="flex flex-col sm:flex-row gap-2">
              <input className="flex-1 rounded-xl border border-neutral-200 p-3" placeholder="Enter your email address" />
              <button className="btn bg-neutral-900 text-white">Subscribe to Newsletter</button>
            </form>
          </div>
